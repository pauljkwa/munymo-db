...
import { Loader2, RefreshCw, AlertTriangle, Smartphone, Laptop, Tablet, HelpCircle, CheckCircle, XCircle } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Comprehensive analytics dashboard for device usage across the platform.
          </p>
          {analytics && (
                ...
                {analytics && notificationCategoryData.length > 0 ? (
                  <>
                    <div className="text-xl font-bold capitalize">
                      {notificationCategoryData.sort((a, b) => b.value - a.value)[0].name.replace('_', ' ')}
                    </div>
                    <p className="text-xs text-muted-foreground mt-1">
                      {notificationCategoryData.sort((a, b) => b.value - a.value)[0].value} users
                    </p>
                  </>
                ) : (
